/**
 * @see https://github.com/microsoft/TypeScript/issues/43797?ref=nehalist.io#issuecomment-1311633838
 */
...
interface TypedFormData<T extends Record<string, TypedFormDataValue>> {
    ...
    forEach<K extends keyof T>(callbackfn: (value: T[K], key: K, parent: TypedFormData<T>) => void, thisArg?: unknown): void;
}
